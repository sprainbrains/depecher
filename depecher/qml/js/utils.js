...
/*
  ...
  */
    switch(state){
    //case 0: return qsTr("Waiting for network")
    case 0: return qsTr("Wait lib parameters")
    case 1: return qsTr("Wait encryption key")
    case 2: return qsTr("Wait phone number")
    case 3: return qsTr("Wait code")
    case 4: return qsTr("Wait registration")
    case 5: return qsTr("Wait password")
    case 6: return qsTr("Wait logging out")
    case 7: return qsTr("Wait closing")
    case 8: return qsTr("Wait closed")
    case 9: return qsTr("Ready")
